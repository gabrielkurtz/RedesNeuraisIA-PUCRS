...
public class MLP {
    ...
    public void setWeights(int indice){
        int cont = 0;
        while(cont<32){
            double a1 = 1/gen.pop[cont][2];
            double a2 = 1/gen.pop[cont+1][2];
            double a3 = 1/gen.pop[cont+2][2];
            double a4 = 1/gen.pop[cont+4][2];
                    
            input[indice] = new Neuronio((1/gen.pop[cont][2])*Math.random(), 1/gen.pop[cont+1][2]*Math.random(), 1/gen.pop[cont+2][2]*Math.random(), 1/gen.pop[cont+2][2]*Math.random());
            cont+=4;
            output[indice] = new Neuronio(1/gen.pop[cont][2]*Math.random(), 1/gen.pop[cont+1][2]*Math.random(), 1/gen.pop[cont+2][2]*Math.random(), 1/gen.pop[cont+2][2]*Math.random());
            cont+=4;
        }
